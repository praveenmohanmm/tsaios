    ...
    private var radiusLegendCard: some View {
        VStack(alignment: .leading, spacing: 6) {
            Text("Alert Radius")
                .font(.caption)
                .foregroundColor(.gray)
            legendRow(label: "17–30 km/h",  radius: "50 m")
            legendRow(label: "30–50 km/h",  radius: "60 m")
            legendRow(label: "50–60 km/h",  radius: "80 m")
            legendRow(label: "60–70 km/h",  radius: "90 m")
            legendRow(label: "70–100 km/h", radius: "100 m")
        }
        .padding()
        .frame(maxWidth: .infinity, alignment: .leading)
        .background(cardBackground)
